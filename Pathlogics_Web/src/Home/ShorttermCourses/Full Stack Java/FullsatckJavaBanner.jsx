...
export default function FullStackJavaBanner() {
    ...
    <>
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto px-4 text-lg text-white py-4 ">
          Become a certified Full Stack Java Developer in Pune with Certification. Get real-time project exposure and placement assistance to land your dream job.
