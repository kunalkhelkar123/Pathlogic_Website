...
export default function FullJavaOverview() {
  return (
      ...
      <div className="relative min-h-[200px] bg-gradient-to-br from-gray-900 to-teal-600 py-10">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-8">
            Full Stack Java Training Program Overview
          </h3>
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Our Full Stack Java Training course in Pune is the ideal opportunity for anyone looking to launch a career in web development. Whether you're a beginner or looking to enhance your skills in Java, Spring Boot, front-end technologies, and database management, we’ve got you covered. Ready to take your development skills to the next level? Explore our simple admission process and take your first step toward becoming a certified Full Stack Java Developer.
          </p>
        </div>
      </div>
            ...
            <div className="p-6">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Basic Understanding of Java & Web Technologies
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Open to Anyone Eager to Learn and Build Real Projects
                </li>
              </ul>
            </div>
          </div>
