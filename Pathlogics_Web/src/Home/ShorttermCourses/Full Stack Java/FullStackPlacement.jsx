  ...
  const details = [
    {
      ...
      description: "Learn React.js, modern UI development, and state management.",
    },
    {
      title: "Backend Development with Java & Spring Boot",
      description: "Master Java, Spring Boot, REST APIs, and Microservices.",
    },
    {
      title: "Database & Cloud Deployment",
      description: "Understand SQL, NoSQL, and deploy applications using AWS and Docker.",
    }
  ];
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="Database & Deployment">Database & Deployment</option>
            </select>
