  ...
  const details = [
{
  ...
  return (
    ...
    >
     ...
     Learn Automation: Selenium with Java Course in Pune
        </h1>
      </motion.div>

      <div className="text-center max-w-3xl mx-auto px-4 text-lg text-white py-4">
 
Take your software testing skills to the next level with our Selenium with Java Course in Pune. Master automation testing concepts, tools, and frameworks to become an expert in the field.
