  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6 text-center">
          Short-Term  <span className="text-orange-600">Selenium with Java</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
        Master Selenium with Java concepts and become a proficient Selenium with Java developer with expert-led training.
        </p>
      </motion.div>
