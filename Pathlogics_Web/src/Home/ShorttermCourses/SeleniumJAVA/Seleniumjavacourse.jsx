...
export default function SeleniumJavaCourse() {
  const courseModules = [
    { title: "Introduction to Selenium", icon: "🚀" },
    { title: "Java Basics for Selenium", icon: "☕" },
    { title: "WebDriver Setup", icon: "🛠️" },
    { title: "Locators & WebElements", icon: "🔍" },
    { title: "Handling Pop-ups", icon: "📢" },
    { title: "Testing Framework", icon: "🧪" },
    { title: "Page Object Model", icon: "📄" },
  ];
