...
export default function DataSciencePlacement() {
  ...
  const details = [
    {
      ...
      description: "Learn the fundamentals of Python, libraries like Pandas, NumPy, and Matplotlib for data manipulation and visualization.",
    },
    {
      title: "Machine Learning Basics",
      description: "Understand key ML algorithms, data preprocessing techniques, and model building using Scikit-Learn.",
    },
    {
      title: "Data Visualization",
      description: "Master tools like Matplotlib, Seaborn, and Power BI to create insightful visualizations from raw data.",
    }
  ];
