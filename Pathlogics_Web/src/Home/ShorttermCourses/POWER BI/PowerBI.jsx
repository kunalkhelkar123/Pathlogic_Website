...
//       description: "Learn the basics of Power BI, its interface, and how to use it for data analysis and visualization.",
//     },
//     {
//       title: "Data Transformation and Cleaning",
//       description: "Master the art of transforming and cleaning data in Power BI using Power Query Editor.",
//     },
//     {
//       title: "Creating Reports and Dashboards",
//       description: "Understand how to create interactive reports and dashboards to visualize data effectively.",
//     },
//     {
//       title: "DAX Formulas and Functions",
//       description: "Dive deep into Data Analysis Expressions (DAX) for performing advanced data calculations in Power BI.",
//     },
//     {
//       title: "Power BI Service and Sharing",
//       description: "Learn how to use Power BI Service to publish and share reports, and collaborate with teams.",
//     },
//   ];
...
//           Power BI <span className="text-orange-600">Placement Guarantee</span> Program
//         </h1>
//         <p className="text-lg text-white mb-12 text-center">
//           Master Power BI for data analysis and get <strong>100% Placement Support</strong> with expert-led training.
//         </p>
//       </motion.div>
...
//               <option value="Introduction to Power BI">Introduction to Power BI</option>
//               <option value="Data Transformation and Cleaning">Data Transformation and Cleaning</option>
//               <option value="Creating Reports and Dashboards">Creating Reports and Dashboards</option>
//               <option value="DAX Formulas and Functions">DAX Formulas and Functions</option>
//               <option value="Power BI Service and Sharing">Power BI Service and Sharing</option>
//             </select>
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6 text-center">
          Short-Term  <span className="text-orange-600">Power BI</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
        Master Power BI concepts and become a proficient Power BI developer with expert-led training.
        </p>
      </motion.div>
