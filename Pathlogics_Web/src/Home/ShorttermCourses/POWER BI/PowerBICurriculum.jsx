...
const CourseModule = ({ title, icon, index }) => {
  ...
  return (
    ...
    >
      <div className="bg-orange-600 rounded-lg shadow-lg p-6 h-full hover:shadow-2xl hover:bg-gradient-to-br from-gray-900 to-teal-500 transition-shadow duration-300">
...
export default function PowerBICurriculum() {
  const courseModules = [
    { title: "Introduction to Power BI", icon: "📊" },
    { title: "Data Transformation", icon: "🔄" },
    { title: "Data Modeling", icon: "📈" },
    { title: "DAX Functions", icon: "🔢" },
    { title: "Data Visualization", icon: "🎨" },
    { title: "Power BI Service", icon: "☁️" },
    { title: "Advanced Analytics", icon: "📡" },
    { title: "Power BI Reports", icon: "📑" },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Dive deep into Power BI with our structured curriculum covering all essential topics.
          </p>
        </div>
