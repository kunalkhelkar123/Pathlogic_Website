  ...
  const details = [
    {
      ...
      description: "Learn how to perform manual testing to identify software bugs, defects, and issues in applications.",
    },
    {
      title: "Automated Testing",
      description: "Master automated testing tools like Selenium, QTP, and TestComplete to test software applications efficiently.",
    },
    {
      title: "Performance Testing",
      description: "Understand how to assess software performance and scalability using tools like JMeter and LoadRunner.",
    }
  ];
    ...
    >
      <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        <h1 className="text-4xl text-white font-bold mb-6">
          Software Testing <span className="text-orange-600">Placement Guarantee</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master Software Testing techniques and get <strong>100% Placement Support</strong> with expert-led training.
        </p>
      </motion.div>
