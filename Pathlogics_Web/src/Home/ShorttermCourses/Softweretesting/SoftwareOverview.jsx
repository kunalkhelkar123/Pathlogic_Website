        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden transform transition duration-300 hover:scale-105">
            ...
            <div className="px-8 py-3 bg-orange-500 text-center">
              <button className="text-white font-semibold transition duration-300 hover:bg-orange-700 px-4 py-1 rounded-md">
                Know More
              </button>
            </div>
          </div>
            ...
            <div className="p-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-center text-gray-700">
                  ...
                  B.E / B.Tech / M.Tech / MCA / BCA in any specialization.
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Professionals seeking to shift careers into software testing.
                </li>
              </ul>
            </div>
            <div className="px-8 py-3 mt-[40px] bg-orange-500 text-center">
              <button className="text-white font-semibold transition duration-300 hover:bg-orange-700 px-4 py-1 rounded-md">
                Know More
              </button>
            </div>
