...
Blogs() {
  return (
    <div className="bg-gradient-to-br from-sky-50 via-white to-cyan-50 min-h-screen flex items-center justify-center py-16 px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32">
