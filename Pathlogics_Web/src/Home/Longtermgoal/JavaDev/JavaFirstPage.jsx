...
export default function FullStackPlacement() {
  ...
  const details = [
    {
      title: "Frontend Development (Java)",
      description: "Master HTML, CSS, JavaScript, and Java-based frameworks like Spring for building interactive web applications.",
    },
    {
      title: "Backend Development (Java)",
      description: "Learn Java with Spring Boot, Hibernate, and database management using MySQL and PostgreSQL.",
    },
    {
      title: "Deployment & DevOps",
      description: "Understand CI/CD, cloud deployment, and server management with AWS, Docker, and Kubernetes.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6">
          Long-Term <span className="text-orange-600">FullStack Java Developement</span>{" "}
          Course
        </h1>
        <p className="text-lg text-white mb-12">
          Gain essential FullStack Java skills in a short duration with expert
          guidance.
        </p>
      </motion.div>
