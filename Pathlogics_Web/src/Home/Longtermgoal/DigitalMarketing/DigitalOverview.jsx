      ...
      <div className="relative bg-gradient-to-br from-orange-500 to-orange-500 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Digital Marketing is the practice of promoting products or services using digital channels to reach consumers. Learn key strategies in SEO, Social Media Marketing, Email Marketing, and more. A Digital Marketing expert is skilled in analytics, content creation, and online advertising to increase brand awareness and drive traffic.
          </p>
        </div>
      </div>
            ...
            <div className="p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Professionals working on digital platforms & interest in Digital Marketing.
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-orange-600">
