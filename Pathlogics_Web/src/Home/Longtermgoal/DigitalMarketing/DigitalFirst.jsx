...
export default function DigitalFirst() {
  ...
  const details = [
    {
      title: "SEO & SEM",
      description: "Master SEO strategies and Search Engine Marketing to drive website traffic and boost online presence.",
    },
    {
      title: "Social Media Marketing",
      description: "Learn how to create and manage social media campaigns on platforms like Facebook, Instagram, and LinkedIn.",
    },
    {
      title: "Content Marketing & Analytics",
      description: "Understand content creation, marketing strategies, and analytics to measure campaign success.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6">
          Long-Term <span className="text-orange-600">Diploma in Digital marketing</span>{" "}
          Course
        </h1>
        <p className="text-lg text-white mb-12">
          Gain essential Diploma in Digital Marketing in a short duration with expert
          guidance.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="Content Marketing & Analytics">Content Marketing & Analytics</option>
