...
import Courses from "../Courses_offer/Courses_offer"

const TechLogo = ({ children, color }) => (
  <div className={`w-10 h-10 md:w-28 md:h-28 rounded-full flex items-center justify-center ${color} shadow-lg transform transition-transform duration-300 hover:scale-110`}>
    {children}
  </div>
);
    ...
    <div className="min-h-[200px]  py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6">
          <h1 className="text-[32px] sm:text-[40px] md:text-[40px] font-extrabold text-gray-900 leading-tight mb-4">
          A comprehensive Full Stack 
            <span className="block text-indigo-600">Development Course</span>
          </h1>
          <p className="text-lg sm:text-2xl md:text-2xl text-gray-800 mt-4  sm:px-24 md:px-24">
          Master the skills needed to build dynamic web applications from start to finish. Our Full Stack Development course covers front-end, back-end, databases, and everything in between!
          </p>
        </div>
        ...
        {/* <div className="flex flex-wrap justify-center items-center gap-8 sm:gap-12 ">
          <div className="flex flex-col items-center space-y-4">
            <TechLogo color="bg-green-500">
              <svg className="w-5 h-5 sm:w-12 sm:h-12 text-white" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex flex-col items-center space-y-4">
            <TechLogo color="bg-gray-800">
              <span className="text-white text-xl font-bold">ex</span>
            </TechLogo>
        ...
        {/* <div className="mt-10 text-center">
          ...
          <button className="inline-block py-2 px-2 sm:px-3  sm:py-2 border border-teal-600 bg-teal-600 text-white rounded-md hover:bg-teal-800 transition">
          Start Learning Now
          </button>
          </Link>
        </div> */}
