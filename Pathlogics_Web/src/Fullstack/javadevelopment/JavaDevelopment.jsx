...
const TechLogo = ({ children, color }) => (
  <div
    className={`w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 rounded-full flex items-center justify-center ${color} shadow-lg transform transition-transform duration-300 hover:scale-110`}
  >
    {children}
  </div>
);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 mt-4">
            Learn Java Web Development with theoretical & practical hands-on coding experience.
          </p>
        </div>

        {/* Tech Logos Section */}
        <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 mt-16">
          <div className="flex flex-col items-center space-y-4 text-center w-28 sm:w-32 md:w-40">
            <TechLogo color="bg-purple-700">
              <Coffee className="w-10 h-10 sm:w-12 sm:h-12 text-white" />
            </TechLogo>
            <span className="text-base sm:text-lg font-semibold text-purple-700">Java Language</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4 text-center w-28 sm:w-32 md:w-40">
            ...
            <span className="text-base sm:text-lg font-semibold text-orange-600">Hibernate ORM</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4 text-center w-28 sm:w-32 md:w-40">
            ...
            <span className="text-base sm:text-lg font-semibold text-green-700">Spring Framework</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4 text-center w-28 sm:w-32 md:w-40">
            ...
            <span className="text-base sm:text-lg font-semibold text-blue-600">Thymeleaf Engine</span>
          </div>
        </div>
        ...
        <div className="mt-20 text-center">
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-600 mb-8">
            Master the entire Java web development stack.
          </p>
          <button className="bg-orange-600 text-white text-lg sm:text-xl md:text-2xl font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-lg shadow-lg hover:bg-orange-700 transition duration-300 transform hover:scale-105">
            Start Learning Now
          </button>
        </div>
      </div>
