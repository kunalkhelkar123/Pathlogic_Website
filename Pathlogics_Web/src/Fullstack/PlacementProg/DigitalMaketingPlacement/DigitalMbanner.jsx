...
export default function DigitalMBanner() {
  ...
  const handleDownload = () => {
    ...
    link.download = "DigitalMarketingBrochure.pdf";
  ...
  const details = [
    {
      ...
      description: "Optimize your website for search engines to drive organic traffic and improve rankings.",
    },
    {
      title: "Pay-Per-Click (PPC) Advertising",
      description: "Master Google Ads and Bing Ads to create high-converting paid advertising campaigns.",
    },
    {
      title: "Social Media Marketing",
      description: "Build effective social media strategies on platforms like Facebook, Instagram, LinkedIn, and Twitter.",
    },
  ];
    ...
    >
      <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        <h1 className="text-4xl text-white font-bold mb-6">
          Digital Marketing <span className="text-orange-600">Mastery Program</span>
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master SEO, PPC, Social Media, and more with <strong>100% Job Support</strong>.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="Analytics & Data Analysis">Analytics & Data Analysis</option>
            </select>
