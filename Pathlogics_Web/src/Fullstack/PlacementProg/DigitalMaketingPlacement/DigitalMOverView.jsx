...
export default function DigitalMOverview() {
  return (
      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Learn SEO, PPC, Content Marketing, Social Media Strategy, and Data Analytics to drive online growth.
            Get hands-on experience with industry-leading tools like Google Ads, SEMrush, Hootsuite, and more.
          </p>
        </div>
      </div>
            ...
            <div className="p-8 flex-grow">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Aptitude & Digital Marketing Assessment
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Enrollment & Course Kickoff
                </li>
              </ul>
            </div>
            ...
            <div className="p-8 flex-grow">
              ...
              <ul className="space-y-4">
                <li className="flex items-center text-gray-700">
                  ...
                  Graduates from Marketing, Business, or related fields
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Professionals with experience in marketing or content creation
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Enthusiasts eager to enhance their digital marketing skills
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-orange-600">
