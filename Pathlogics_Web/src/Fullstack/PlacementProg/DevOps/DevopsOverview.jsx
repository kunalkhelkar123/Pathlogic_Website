      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Learn the principles of DevOps, automation, CI/CD pipelines, containerization, and cloud deployment.
            Gain hands-on experience with industry-standard tools and technologies while working on real-world projects.
          </p>
        </div>
      </div>
            ...
            <div className="p-8 flex-grow">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Professionals with experience in software development
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Enthusiasts eager to implement CI/CD pipelines and work with containers
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-orange-600">
