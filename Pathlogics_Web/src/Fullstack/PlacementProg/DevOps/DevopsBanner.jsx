  ...
  const details = [
    {
      ...
      description:
        "Understand the DevOps culture, principles, and the importance of collaboration between development and operations teams.",
    },
    {
      title: "Version Control with Git & GitHub",
      description:
        "Master Git for version control, learn GitHub for collaboration, and handle branching, merging, and pull requests.",
    },
    {
      title: "Continuous Integration & Delivery (CI/CD)",
      description:
        "Learn the process of automating testing and deployment using Jenkins, GitLab, or CircleCI for continuous integration and delivery.",
    },
    ...
    >
      ...
      >
        <h1 className="text-4xl text-white font-bold mb-6">
           DevOps{" "}
          <span className="text-orange-600">Placement Guarantee</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master DevOps practices and get{" "}
          <strong>100% Placement Support</strong> with expert-led training.
        </p>
      </motion.div>
      ...
      {showPopup && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: -20 }}
          className="fixed bottom-10 right-10 bg-gradient-to-br from-gray-900 to-teal-600 text-white px-6 py-3 rounded-lg shadow-lg"
        >
