  ...
  const details = [
    {
      ...
      description: "Master HTML, CSS, JavaScript, and React.js to build interactive web applications.",
    },
    {
      title: "Backend Development",
      description: "Learn Node.js, Express.js, and database management using MongoDB and SQL.",
    },
    {
      title: "Deployment & DevOps",
      description: "Understand CI/CD, cloud deployment, and server management with AWS and Docker.",
    },
  ];
    ...
    >
      <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        <h1 className="text-4xl text-white font-bold mb-6">
          Java Full Stack <span className="text-orange-600">Placement Guarantee</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master Full Stack Development and get <strong>100% Placement Support</strong> with expert-led training.
        </p>
      </motion.div>
