      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Master manual and automation testing, API testing, performance testing, and CI/CD integration. 
            Gain hands-on experience with Selenium, Cypress, JMeter, Postman, and DevOps tools under expert mentorship.
          </p>
        </div>
      </div>
            ...
            <div className="p-8 flex-grow">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Professionals with experience in software testing or development
                </li>
                <li className="flex items-center text-gray-700">
                  <svg className="w-5 h-5 mr-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  Enthusiasts eager to master automation & manual testing
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-teal-600">
