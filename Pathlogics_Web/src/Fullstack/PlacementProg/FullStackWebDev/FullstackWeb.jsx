      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Learn to build modern web applications from scratch with front-end, back-end, databases, and deployment.
            Gain hands-on experience with industry-standard tools and technologies guided by expert mentors.
          </p>
        </div>
      </div>
            ...
            <div className="p-8 flex-grow">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Enthusiasts eager to build full-stack applications
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-teal-600">
