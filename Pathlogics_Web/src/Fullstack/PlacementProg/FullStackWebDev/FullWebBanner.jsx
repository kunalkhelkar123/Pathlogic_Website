...
export default function FullWebBanner() {
  ...
  const details = [
    {
      ...
      description:
        "Master HTML, CSS, JavaScript, and React.js to build interactive web applications.",
    },
    {
      title: "Backend Development",
      description:
        "Learn Node.js, Express.js, and database management using MongoDB and SQL.",
    },
    {
      title: "Deployment & DevOps",
      description:
        "Understand CI/CD, cloud deployment, and server management with AWS and Docker.",
    },
  ];
    ...
    >
      ...
      >
        ...
        <p className="text-lg text-white mb-12 text-center">
          Master Full Stack Development and get{" "}
