...
export default function WebCurriculum() {
  const courseModules = [
    { title: "HTML & CSS", icon: "🌐" },
    { title: "JavaScript & ES6+", icon: "⚡" },
    { title: "React.js & Components", icon: "⚛️" },
    { title: "Node.js & Express.js", icon: "🖥️" },
    { title: "RESTful APIs & GraphQL", icon: "🔗" },
    { title: "MongoDB & SQL", icon: "🗄️" },
    { title: "DevOps & Deployment", icon: "🚀" },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Learn to build scalable, full-stack web applications using modern frontend and backend technologies.
          </p>
        </div>
