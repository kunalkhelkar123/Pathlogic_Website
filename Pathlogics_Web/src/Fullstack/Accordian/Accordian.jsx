...
export default function Accordian() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-20  py-16 px-4 sm:px-6 lg:px-8">
     {/* image section */}
        <div>
          <img className="rounded-md shadow-2xl" src={curriculam}></img>
        </div>
     ...
     {/* Course Curriculum section */}
      ...
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-extrabold text-center text-orange-600 mb-12"> Full Stack Development Course Curriculum</h1>
