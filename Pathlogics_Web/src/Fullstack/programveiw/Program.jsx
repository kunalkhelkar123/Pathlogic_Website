      ...
      <div className="relative min-h-[200px] bg-gradient-to-br from-gray-900 to-teal-600 py-10">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-8">
            Full Stack Development Program overview
          </h3>
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Our Full Stack Development course equips you with the tools to create end-to-end
            web applications. Ready to take the next step? Here's everything you need to know
            about the admission process and eligibility requirements.
