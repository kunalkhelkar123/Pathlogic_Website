    ...
    >
      ...
      >
        <div className="w-full flex justify-center">
          <h1 className="text-[40px] font-bold mb-4 text-orange-600 text-center whitespace-nowrap text-ellipsis">
  Best Angular JS Course in Pune with Certification
</h1>
        </div>
        <p className="text-lg text-white text-center leading-relaxed">
          Join the most trusted Angular JS course in Pune and gain in-demand skills. Our certification adds value to your resume and opens doors to top IT jobs.
        </p>
      </motion.div>
