...
import image from "../../assets/dss.png";
          ...
          >
            ...
            <div className="space-y-4">
              <p className="text-xl md:text-2xl text-orange-300">
                Online & Offline Batches – Learn Python, Machine Learning, and AI to Excel in Data Science.
              </p>
            </div>
            ...
            >
              <Link to="/quickenquiry">Enroll Now!</Link>
            </motion.button>
          </motion.div>
