...
export default function ReactProgramO() {
  return (
      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            React.js is a powerful library for building dynamic, user-friendly
            web applications. Our program offers comprehensive training on React.js
            fundamentals such as components, JSX, hooks, state management, routing,
            and testing, empowering learners to become proficient in modern frontend
            development.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <Card
            ...
            items={[
              ...
              "Aptitude for Frontend Development",
          ...
          <Card
            ...
            items={[
              "Graduates or Professionals with Web Development Interest",
              "Familiarity with JavaScript and ES6+ Features",
