...
export default function ReactCurriculum() {
  const courseModules = [
    { title: "React Components & JSX", icon: "⚛️" },
    { title: "React Hooks", icon: "🪝" },
    { title: "State Management with Redux", icon: "🗃️" },
    { title: "React Router", icon: "🛣️" },
    { title: "React Context API", icon: "🔄" },
    { title: "React Testing", icon: "🧪" },
    { title: "Performance Optimization", icon: "⚡" },
    { title: "React Deployment", icon: "🚀" }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Master the advanced concepts of React with our comprehensive curriculum.
          </p>
        </div>
