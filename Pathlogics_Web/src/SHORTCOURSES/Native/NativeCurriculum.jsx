...
export default function NativeCurriculum() {
  const courseModules = [
    { title: "Introduction to React Native", icon: "📱" },
    { title: "React Native Components", icon: "🧩" },
    { title: "State Management", icon: "🔄" },
    { title: "Navigation in React Native", icon: "🗺️" },
    { title: "APIs & Data Fetching", icon: "🔗" },
    { title: "Styling in React Native", icon: "🎨" },
    { title: "Performance Optimization", icon: "⚡" },
    { title: "Deploying React Native Apps", icon: "🚀" }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Dive into our meticulously designed curriculum to master React Native.
          </p>
        </div>
        ...
        <div className="text-center">
          <button className="bg-orange-500 text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:bg-blue-600 transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
            Enroll Now
          </button>
        </div>
      </div>
