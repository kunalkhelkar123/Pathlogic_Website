  ...
  const details = [
    {
      ...
      description: "Learn the core concepts of React Native, including components, navigation, and styling to build cross-platform mobile apps.",
    },
    {
      title: "Building Mobile UIs",
      description: "Master the techniques of creating intuitive mobile user interfaces for both iOS and Android devices.",
    },
    {
      title: "State Management in React Native",
      description: "Understand how to manage state in a React Native application using Context API, Redux, and other state management tools.",
    },
  ];
    ...
    >
      <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        <h1 className="text-4xl text-white font-bold mb-6 text-center">
          Short-Term <span className="text-orange-600">React Native</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master React Native and build high-performance mobile applications for both Android and iOS with expert-led training.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="ReactNativeFundamentals">React Native Fundamentals</option>
              <option value="MobileUI">Building Mobile UIs</option>
              <option value="StateManagement">State Management in React Native</option>
            </select>
