      ...
      <div className="flex flex-col md:flex-row items-center bg-white p-6 md:p-10 rounded-lg shadow-lg gap-8">
        ...
        <div className="w-full md:w-1/2">
          ...
          <p className="text-gray-700 mt-4 text-base sm:text-lg leading-relaxed">
            Upon completing the core java course at Pathlogics, you'll receive the AWS DevOps Certification, a clear recognition of your skills in cloud automation, CI/CD pipelines, and AWS services. This certification reflects the practical experience you've gained while working on real-world projects, making you ready to take on exciting roles in the cloud computing world.
