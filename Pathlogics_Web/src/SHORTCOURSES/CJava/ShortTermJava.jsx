  ...
  return (
    ...
    >
      ...
      >
       ...
       Core Java Course in Pune with Placement Assistance

        </h1>
      </motion.div>

      <div className="text-center max-w-3xl mx-auto px-4 text-lg text-white py-4">
 Boost your programming skills with our Core Java Course in Pune with Placement Support. Learn from experts and step confidently into the IT industry.
