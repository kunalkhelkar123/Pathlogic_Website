  ...
  const details = [
    {
      ...
      description: "Understand the fundamentals of Core Java, including variables, data types, control flow, and basic object-oriented programming concepts.",
    },
    {
      title: "Object-Oriented Programming",
      description: "Learn the core concepts of OOP in Java, such as classes, objects, inheritance, polymorphism, encapsulation, and abstraction.",
    },
    {
      title: "Core Java Libraries",
      description: "Explore essential libraries in Java like Collections, Streams, and java.util package for efficient data management and manipulation.",
    },
    ...
    >
      <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        <h1 className="text-4xl text-white font-bold mb-6 text-center">
         Short-Term Core <span className="text-orange-600">Java</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master the core concepts of Java programming with expert-led training.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="CoreJavaIntro">Introduction to Core Java</option>
              <option value="OOPConcepts">Object-Oriented Programming</option>
              <option value="CoreJavaLibraries">Core Java Libraries</option>
              <option value="ExceptionHandling">Exception Handling in Java</option>
              <option value="Multithreading">Multithreading and Concurrency</option>
              <option value="IOinJava">Input/Output (I/O) in Java</option>
            </select>
