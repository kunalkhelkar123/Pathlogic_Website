...
export default function ShortTermDnetAngular() {
  ...
  const details = [
    {
      title: "DotNet Angular Basics",
      description: "Learn the basics, including creating Web APIs, MVC applications, and connecting to databases using Entity Framework Core.",
    },
    {
      title: "Angular Fundamentals",
      description: "Master the core concepts of Angular, including components, directives, services, and routing to build dynamic single-page applications.",
    },
    {
      title: "Building Web APIs with DotNet",
      description: "Understand how to build scalable and secure Web APIs using .NET Core, handling HTTP requests and responses efficiently.",
    }, 
  ];
    ...
    >
      <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        <h1 className="text-4xl text-white font-bold mb-6 text-center">
          Short-Term <span className="text-orange-600"> DotNet with Angular</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master DotNet with Angular to build dynamic and scalable full-stack web applications with expert-led training.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="DotNetCoreBasics">.NET Core Basics</option>
              <option value="AngularFundamentals">Angular Fundamentals</option>
              <option value="WebAPI">Building Web APIs with .NET</option>
              <option value="DotNetAngularIntegration">Integrating .NET with Angular</option>
              <option value="AuthenticationAuthorization">Authentication & Authorization</option>
              <option value="DeploymentDevOps">Deployment & DevOps</option>
            </select>
