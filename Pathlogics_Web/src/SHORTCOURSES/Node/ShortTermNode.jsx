...
export default function ShortTermNodeJS() {
  ...
  const details = [
    {
      ...
      description: "Learn the core concepts of Node.js, including server-side programming, Express.js, and building scalable applications.",
    },
    {
      title: "Building APIs with Express.js",
      description: "Master RESTful API development with Express.js, handling routes, requests, and responses for robust backend services.",
    },
    {
      title: "Database Integration with MongoDB",
      description: "Understand how to integrate MongoDB with Node.js to build data-driven applications, using Mongoose for efficient data management.",
    },
  ];
  ...
  return (
   ...
   Short-Term <span className="text-orange-600">Node.JS</span> Program
        </h1>
        <p className="text-lg text-white mb-12 text-center">
          Master Node.js and build powerful backend applications with expert-led training.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="NodeJSFundamentals">Node.js Fundamentals</option>
              <option value="ExpressAPI">Building APIs with Express.js</option>
              <option value="MongoDBIntegration">Database Integration with MongoDB</option>
            </select>
