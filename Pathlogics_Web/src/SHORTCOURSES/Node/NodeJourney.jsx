    ...
    <div className="bg-gradient-to-br from-gray-900 to-teal-600 min-h-screen flex flex-col items-center p-6">
      ...
      <div className="text-center">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-white">
           <span className="text-orange-600">Node.JS Journey</span>
        </h1>
        <p className="text-white mt-2 text-lg sm:text-xl">
          Your path to becoming a pro developer
        </p>
        <button
          className="mt-4 px-5 py-2 text-sm sm:text-base font-semibold text-white bg-ornage-600 hover:bg-orange-700 rounded-[5px] shadow-lg hover:scale-105 transition"
