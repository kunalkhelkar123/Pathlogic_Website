...
export default function DotnetProgramo() {
  return (
      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            DotNet Core is a powerful, cross-platform framework for building modern web applications. Our program offers comprehensive training on .NET Core fundamentals such as MVC, Entity Framework, Web API development, authentication, and deployment, empowering learners to become proficient in backend and full-stack development.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <Card
            ...
            items={[
              ...
              "Aptitude for Backend Development",
          ...
          <Card
            ...
            items={[
              "Graduates or Professionals with an Interest in Backend Development",
              "Familiarity with C# and DotNet Core Framework",
