...
// const records = [
//   { month: 'JUNE', year: '2024', students: 167 },
//   { month: 'MAY', year: '2024', students: 150 },
//   { month: 'APRIL', year: '2024', students: 130 },
//   { month: 'MARCH', year: '2024', students: 145 },
//   { month: 'FEBRUARY', year: '2024', students: 138 },
// ]
...
export default function PlacementRecords() {
  ...
  const next = useCallback(() => {
    setCurrentIndex((prevIndex) => (prevIndex + 1 >= records.length ? 0 : prevIndex + 1));
  }, []);

  const prev = () => {
    setCurrentIndex((prevIndex) => (prevIndex - 1 < 0 ? records.length - 1 : prevIndex - 1));
  };
          ...
          <div className="w-72 overflow-hidden">
            <div className="transform transition-all duration-300 scale-100 opacity-100">
              <div className="w-full rounded-lg bg-white p-6 shadow-lg">
                <div className="mb-4 text-center">
                  <h2 className="text-3xl font-semibold text-gray-600">
                    {records[currentIndex].month}
                  </h2>
                  <p className="text-2xl text-orange-500">{records[currentIndex].year}</p>
                </div>
                <div className="text-center">
                  <p className="text-5xl font-bold text-orange-500">
                    {records[currentIndex].students}
                  </p>
                  <p className="mt-2 text-sm text-gray-600">Students Recruited</p>
                </div>
              </div>
            </div>
          </div>
