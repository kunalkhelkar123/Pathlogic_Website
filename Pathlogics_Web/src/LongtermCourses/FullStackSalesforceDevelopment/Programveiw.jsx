      ...
      <div className="relative min-h-[200px] bg-gradient-to-br from-gray-900 to-teal-600 py-10">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Enhance your career prospects with our <strong>Salesforce Developer Training in Pune</strong>, where you’ll learn both fundamental and
            advanced Salesforce concepts. Gain the skills needed to develop, customize, and manage Salesforce applications effectively.
            Looking to start your journey in Salesforce? Explore our admission process and eligibility criteria to take the first step
            toward becoming a certified Salesforce professional.
