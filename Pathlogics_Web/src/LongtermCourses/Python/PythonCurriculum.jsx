            ...
            <div className="flex flex-col justify-center items-center sm:mb-0 -mb-20 py-6 px-4 sm:px-8 bg-cover bg-center">
                <div className="text-center mb-6">
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-black">
                        Essential Tools You’ll Master in Our Full Stack Python Development Course
                    </h3>
                </div>
                <div>
                    <motion.p
                    ...
                    >
Master the tools top developers use in our Python Full Stack Developer course.
With a focus on practical learning, you’ll build full-fledged web applications .By the end of the course, you’ll confidently handle both client-side and server-side coding with real-time project exposure.
                    </motion.p>
                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <TechCard
                            logo={<Code2 className="w-12 h-12 text-gray-700" />} // Python
                            label="Python"
                            color="bg-gray-200"
                        />
                        <TechCard
                            logo={<Workflow className="w-12 h-12 text-red-700" />} // Django
                            label="Django"
                            color="bg-red-200"
                        />
                        <TechCard
                            logo={<Sparkles className="w-12 h-12 text-blue-700" />} // React
                            label="React"
                            color="bg-blue-200"
                        />
                        <TechCard
                            logo={<Layers className="w-12 h-12 text-yellow-700" />} // PostgreSQL
                            label="PostgreSQL"
                            color="bg-yellow-200"
                        />
                    </motion.div>
