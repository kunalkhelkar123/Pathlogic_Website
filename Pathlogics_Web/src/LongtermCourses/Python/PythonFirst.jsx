  ...
  const details = [
    {
      ...
      description: "Master Python syntax, data structures, and algorithms for building robust applications.",
    },
    {
      title: "Web Development with Django",
      description: "Learn web development with Django to build dynamic and scalable web applications.",
    },
    {
      title: "Data Science with Python",
      description: "Get hands-on experience with Python libraries for data analysis, visualization, and machine learning.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6">
          Long-Term <span className="text-orange-600">FullStack Python Developer</span>{" "}
          Course
        </h1>
        <p className="text-lg text-white mb-12">
          Gain essential FullStack Python Developer skills in a short duration with expert
          guidance.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="Python Basics">Python Programming Basics</option>
              <option value="Web Development with Django">Web Development with Django</option>
