    ...
    >
      ...
      >
        <h1 className="text-4xl ml-[10px] text-center font-bold text-orange-600">
          Python Full Stack Developer Course in Pune with Certification

        </h1>
      </motion.div>

      <div className="text-center max-w-3xl mx-auto px-4 text-lg text-white py-4">
 Pathlogics offers Python Full Stack Developer Course in Pune with Certification & 100% Placement Guarantee. Get trained by experts. Enroll today!
        ...
        <div className="grid gap-2 flex-grow">
          ...
          <div className="items-center justify-center text-white p-2 mt-4">
            <p className="text-lg font-semibold text-center mb-4">
              New Python batch starting every Monday!
            </p>
