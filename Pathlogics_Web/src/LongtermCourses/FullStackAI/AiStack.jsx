...
import { Lightbulb, GitBranch, Brain, BarChart } from "lucide-react"; // Using appropriate icons for AI
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl sm:text-3xl md:text-4xl font-extrabold text-white leading-tight mb-4">
            Master the Art of
            <span className="block text-orange-600 text-4xl">AI Development</span>
          </h2>
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 sm:gap-12 mt-12">
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <span className="text-3xl font-bold text-white">AI Basics</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <span className="text-3xl font-bold text-white">Deep Learning</span>
          </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-xl text-orange-400 mb-6">
            Become an AI Development Expert!
          </p>
