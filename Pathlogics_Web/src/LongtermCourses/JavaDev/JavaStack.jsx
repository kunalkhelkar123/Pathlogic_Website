      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        >
          <TechCard
            ...
            label="Java"
            color="bg-gradient-to-br from-gray-200 to-black-500"
          />
          <TechCard
            logo={
              <img
            ...
            label="Spring"
            color="bg-gradient-to-br from-red-200 to-black-500"
          />
          <TechCard
            logo={
              <img
            ...
            label="Hibernate"
            color="bg-gradient-to-br from-yellow-200 to-black-800"
          />
          <TechCard
            logo={
              <img
            ...
            label="MySQL"
            color="bg-gradient-to-br from-blue-200 to-black-800"
          />
        </motion.div>
