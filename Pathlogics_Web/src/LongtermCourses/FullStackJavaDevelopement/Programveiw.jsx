      ...
      <div className="relative min-h-[200px] bg-gradient-to-br from-gray-900 to-teal-600 py-10">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-8">
            Java Full Stack Development Program overview
          </h3>
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Boost your programming skills with our <strong>Java full stack Development course,</strong> where you’ll
            learn both basic and advanced Java techniques. You’ll gain the knowledge to build strong,
            efficient applications used in real-world projects. Interested in joining? Check out our
            <strong>Admission process and eligibility,</strong> designed to help you start your journey to becoming a
            successful <strong>Java developer.</strong>
