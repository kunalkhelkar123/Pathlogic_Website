      ...
      >
        <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <h1 className="text-4xl ml-[10px]  text-center font-bold  text-orange-600">
            Pathologics Java Full Stack Developer Course in Pune with Placement. {" "}
        ...
        <div className="text-center max-w-3xl mx-auto px-4 text-lg text-white py-4 ">
          Master Java Full Stack development with in-depth, hands-on training. Secure job placement with top companies in Pune after completing the course.
