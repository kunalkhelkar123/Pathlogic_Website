      ...
      <div className="relative min-h-[200px] bg-gradient-to-br from-gray-900 to-teal-600 py-10">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-8">
            Dot Net Full Stack Development program overview
          </h3>
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            <strong>Level up your skills with our Dot Net Full Stack Developer course</strong>, where you'll master both
            foundational and advanced concepts. Build real-world applications and get ready to launch a
            rewarding career in development. Check our admission process and eligibility to get started.
