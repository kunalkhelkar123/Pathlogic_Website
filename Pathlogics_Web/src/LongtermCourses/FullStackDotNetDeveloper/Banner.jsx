    ...
    <>
      ...
      >
        <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <h1 className="text-4xl ml-[0px]  text-center font-bold  text-orange-600">
          Become a Dot Net Full Stack Developer in <br/>Pune with Paid Internship at Pathlogics
        ...
        Advance your skills with our Dot Net Full Stack Development course, designed to give you expertise in building complete web applications. Get hands-on experience and unlock new career opportunities.
        </div>
