  ...
  const testimonials = [
   ...
   "With Pathlogics' guidance, I secured a Software Engineer role in a renowned IT MNC with a 16 LPA package! I highly recommend this course."
      },
    {
      ...
      photo: testimonal5,
      review:
        "The practical approach at Pathlogics enabled me to successfully land an Assistant System Engineer role in a top IT MNC."
    },
    {
      name: 'Neha Chavan:',
      photo: testimonal6,
  ...
  return (
    ...
    <section className="py-10 ">
      ...
      <div className="max-w-7xl mx-auto text-center ">
        <h3 className="text-3xl font-bold  mb-3 text-orange-600">What Our Students Say</h3>


        <p className="text-lg sm:text-xl text-gray-800 mb-5">
