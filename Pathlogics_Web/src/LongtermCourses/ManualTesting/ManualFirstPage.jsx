...
import { motion } from "framer-motion";import image from "../../assets/Banner1.jpeg";

//import brochurePDF from "../../../assets/Brochure.pdf";

export default function ManualFirstPage() {
  ...
  const details = [
    {
      ...
      description: "Learn the basics of manual testing including test case design, execution, and bug reporting.",
    },
    {
      title: "Test Case Design & Execution",
      description: "Understand how to write effective test cases, execute them, and report defects.",
    },
    {
      title: "Bug Tracking & Reporting",
      description: "Learn how to use bug tracking tools and effectively report and manage bugs.",
    },
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6">
          Long-Term <span className="text-orange-600">Manual Testing</span>{" "}
          Course
        </h1>
        <p className="text-lg text-white mb-12">
          Gain essential Manual Testing skills in a short duration with expert
          guidance.
        </p>
      </motion.div>
