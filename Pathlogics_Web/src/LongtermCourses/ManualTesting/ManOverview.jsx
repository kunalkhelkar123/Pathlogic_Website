...
export default function ManOverview() {
  return (
      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Manual Testing refers to the process of manually checking software for defects. A manual tester performs test cases manually without the help of automation tools to ensure the software is functioning as expected. Key areas include testing functionality, performance, security, and usability of software applications.
          </p>
        </div>
      </div>
            ...
            <div className="p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Professionals with an interest in manual testing and quality assurance & interest in Manual Testing.
                  .
                </li>
              </ul>
            </div>
