      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            {/* Full stack Web development combines managing servers and databases and 
            system engineering with both front-end and back-end development protocols 
            ...
            Full-stack web development refers to the practice of building both the frontend
             (client-side) and backend (server-side) of a web application. A full-stack developer
              has expertise in handling databases, servers, systems engineering, and user interface design.
            ...
            <div className="p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Professionals working on software testing & interest in full stack web development.
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-orange-600">
