...
export default function DotNetFirstPage() {
  ...
  const details = [
    {
      title: "C# Programming",
      description: "Master C# programming language fundamentals, object-oriented principles, and advanced features.",
    },
    {
      title: "ASP.NET Core & MVC",
      description: "Learn to develop web applications using ASP.NET Core and MVC frameworks for dynamic websites.",
    },
    {
      title: "Database Management",
      description: "Understand database fundamentals using SQL Server and learn how to manage data with Entity Framework.",
    },
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6">
          Long-Term <span className="text-orange-600">FullStack .Net Developer</span>{" "}
          Course
        </h1>
        <p className="text-lg text-white mb-12">
          Gain essential FullStack .NET Developer skills in a short duration with expert
          guidance.
        </p>
      </motion.div>
