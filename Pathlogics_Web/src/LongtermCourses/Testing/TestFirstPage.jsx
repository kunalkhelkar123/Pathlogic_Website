...
export default function TestFirstPage() {
  ...
  const details = [
    {
      ...
      description: "Master manual testing techniques, including test case design, bug tracking, and reporting.",
    },
    {
      title: "Test Case Design & Execution",
      description: "Learn how to design and execute test cases, including functional and regression testing.",
    },
    {
      title: "Automation Testing Overview",
      description: "Understand the basics of test automation with tools like Selenium, and integrate automation into your testing workflow.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6">
          Long-Term <span className="text-orange-600">FullStack Testing</span>{" "}
          Course
        </h1>
        <p className="text-lg text-white mb-12">
          Gain essential FullStack Testing skills in a short duration with expert
          guidance.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="Full Stack Testing">Full Stack Testing</option>
