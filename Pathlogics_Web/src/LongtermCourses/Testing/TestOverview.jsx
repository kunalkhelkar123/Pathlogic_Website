      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Fullstack Testing involves ensuring the quality, functionality, and performance of applications. A Fullstack Testing professional is skilled in manual and automated testing, covering front-end, back-end, database, and API testing using tools like Selenium, JMeter, and Postman.
          </p>
        </div>
      </div>
            ...
            <div className="p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Professionals working in software testing & interested in Fullstack Testing.
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-orange-600">
