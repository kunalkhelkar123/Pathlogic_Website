          ...
          <img className="rounded-md" src={curriculam}></img>
                ...
                <div className="text-center sm:py-6 text-right  justify-end  rounded-xl ">
                    ...
                    <p className="mt-4 text-white text-[16px] text-right flex justify-end leading-relaxed">
                        ...
                        In our Full-Stack Web Development course, you'll learn how to create fully functional
                        websites and applications, handling everything from design to database management.
                        We cover popular tools like HTML, CSS, JavaScript, React, Node.js, and more. Through
                        hands-on projects, you'll build real-world skills that make you ready for a career
                        in web development, all with the support of expert instructors
