...
export default function Component() {
  ...
  return (
    <>
      {/* Main Section */}
      <div
        className=" justify-center items-center  py-6 px-2  bg-cover bg-center"
      >
        <div className="text-center mb-8">
          <h3 className="text-3xl font-extrabold sm:px-24 text-black">
            The Role of MERN and MEAN Stacks in Shaping the Future of Web Development
          </h3>
        </div>


        <div className="grid grid-cols-1 md:grid-cols-2 sm:px-8 gap-20 max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10 p-6">
              <h2 className="text-2xl font-bold text-orange-500 text-center mb-4">Full Stack MERN Development</h2>
              ...
              <p className="text-white mt-6 text-center iten-center justify-center">An advanced, full-stack JavaScript framework perfect for developing modern, high-performance web applications</p>
            ...
            <div className="relative z-10 p-6 flex space-x-2 bg-black">
              ...
              <Link
                to="Full Stack MERN Development"
          ...
          >
            ...
            <div className="relative z-10 p-6">
              <h2 className="text-2xl font-bold text-orange-500 text-center mb-4">Full Stack MEAN Development</h2>
              ...
              <p className="text-white text-center iten-center justify-center mt-6"> A popular JavaScript-based stack tailored for building scalable, maintainable web applications that require extensive data management.</p>
