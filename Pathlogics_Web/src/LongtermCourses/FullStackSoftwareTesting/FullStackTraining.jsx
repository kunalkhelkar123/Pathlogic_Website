...
import abc from "../../../src/assets/testing_automation.jpg";

export default function Blogs() {
    return (
        <div className="pt-10 px-4 md:px-8 lg:px-16 xl:px-24 2xl:px-32">
            ...
            <div className="flex flex-col md:flex-row  sm:-mt-20 items-center justify-between min-h-screen space-y-6 md:space-y-0 md:space-x-8">
                ...
                <div className="md:w-1/2  flex justify-center  ">
                    <img
                        ...
                        className="w-full   sm:-mt-20   -mt-[10]  object-cover "
                    />
                </div>
            </div>
        </div>
