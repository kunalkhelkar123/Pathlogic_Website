  ...
  const details = [
    {
      ...
      description: "Learn Salesforce fundamentals including platform basics, data modeling, and custom objects.",
    },
    {
      title: "Apex Programming",
      description: "Master Apex programming for creating custom logic, triggers, and complex business workflows on Salesforce.",
    },
    {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-4xl text-white font-bold mb-6">
          Long-Term <span className="text-orange-600">FullStack SalesForce Developer</span>{" "}
          Course
        </h1>
        <p className="text-lg text-white mb-12">
          Gain essential FullStack SalesForce Developer skills in a short duration with expert
          guidance.
        </p>
      </motion.div>
        ...
        <motion.div className="bg-gray-800 bg-opacity-60 p-6 w-full max-w-md rounded-lg shadow-lg" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }}>
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <select name="interest" value={formData.interest} onChange={handleChange} className="w-full p-2 border rounded-lg" required>
              ...
              <option value="Apex Programming">Apex Programming</option>
