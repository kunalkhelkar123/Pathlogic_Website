      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-teal-600 py-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-white max-w-4xl mx-auto leading-relaxed">
            Salesforce development focuses on creating custom applications, automating business processes, and managing customer relationships using Salesforce tools like Apex, Lightning, and Visualforce. A Salesforce developer specializes in customizing Salesforce environments for businesses.
          </p>
        </div>
      </div>
            ...
            <div className="p-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center text-gray-700">
                  ...
                  Professionals working on software development & interest in Salesforce development.
                </li>
              </ul>
            </div>
            <div className="px-8 py-4 bg-orange-600">
