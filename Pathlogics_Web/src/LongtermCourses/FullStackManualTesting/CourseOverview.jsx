          ...
          <img className="rounded-md" src={curriculam}></img>
                ...
                <div className="text-center sm:py-6 text-right  justify-end  rounded-xl ">
                    ...
                    <p className="mt-4 text-white text-[16px] text-right flex justify-end leading-relaxed">
                        ...
                        In our Manual Testing Course in Pune, you’ll learn how to ensure software quality by testing applications manually, identifying defects, and improving functionality. You'll master key testing concepts like SDLC, STLC, test case writing, defect tracking, and bug reporting. Our hands-on training includes real-world projects to help you gain practical experience and industry-relevant skills. With expert guidance and interactive sessions, you'll be ready to start a successful career in software testing.
