    ...
    <>
      ...
      >
        <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          Manual Testing Course in pune with Placement
        ...
        Learn the best testing practices with hands-on training in Manual Testing. Prepare for a successful career in software testing and quality assurance.
