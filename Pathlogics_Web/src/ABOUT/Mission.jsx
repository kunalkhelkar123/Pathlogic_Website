    ...
    return (
      <section className="relative overflow-hidden bg-white py-24">
          ...
          <div className="grid gap-8 lg:grid-cols-12">
            ...
            <div className="lg:col-span-4">
              <div className="relative">
                ...
                {/* Mission Title */}
                <div className="relative ">
                  <h2 className="text-2xl font-semibold leading-8 text-orange-600 text-center lg:mr-[52px]">
                    Our Mission
                  </h2>
                ...
                <div className="grid gap-8 sm:grid-cols-2">
                  <div className="space-y-4">
                    <p className="text-base leading-7 text-gray-600">
                      Our mission is to bridge the gap between academics and industry by providing industry-aligned courses that cater to the evolving needs of the IT sector. We believe in the transformative power of education and its ability to unlock opportunities, broaden horizons, and shape successful futures.
                    </p>
                  </div>
                  <div className="space-y-4">
                    <p className="text-base leading-7 text-gray-600">
        ...
        {/* <div className="space-y-4 p-9 mx-auto  pt-[70px] bg-gradient-to-br from-gray-200 to-gray-400 pr-[10px] flex flex-col">
          <div className="w-[100vw]"><h1 className="text-center text-base text-center leading-7 font-bold text-black-600 text-4xl"> LETS CONNECT....</h1>
          <h3 className="text-center text-base text-center leading-7 font-bold text-black-600">Get Trained Get Hired.</h3>
          </div>
